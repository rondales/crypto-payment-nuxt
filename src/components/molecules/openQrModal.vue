<template>
  <div :class="classes">
    ...
    <div class="body">
      <div class="dsc">
        In order to activate the Slash Store Apps, you must issue a deep link to activate your In order to activate the Slash Store Apps, you must issue a deep link to activate your 
      </div>
