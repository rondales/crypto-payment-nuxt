...
import PaymentAction from '@/components/organisms/Payment/ww/fragments/Action'
import PaymentPrice from '@/components/organisms/Payment/ww/fragments/Price'
