...
import PaymentTop from '@/components/organisms/Payment/ww/fragments/PaymentTop'
import LogoText from '@/components/common/LogoText'
import PaymentText from '@/components/organisms/Payment/ww/fragments/Text'
...
export default {
  ...
  methods: {
    ...
    copyLink() {
      ...
      this.$clipboard(
        `${uri.protocol}//${uri.host}/payments-uiswitchable/result/${token}/ww/?rcpt=1`
      )
    },
    toggleMenu(state) {
      this.showMenu = state
