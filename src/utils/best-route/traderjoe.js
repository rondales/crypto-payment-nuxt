...
export default {
  getBestRoute: async (
    ...
    const bestExchange = {
      name: 'traderjoe',
      exchange: exchanges.traderjoe ? exchanges.traderjoe.address : '',
      flag: exchanges.traderjoe ? exchanges.traderjoe.flag : '',
      price: 0
    }
    try {
      ...
      const pairAddress = Pair.getAddress(tokenA, tokenB, chainId)
